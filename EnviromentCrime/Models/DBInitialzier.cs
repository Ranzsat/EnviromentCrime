...
{
    /**
     * Class for Initializing the DB when it doesn't have any data in
     * it. 
     */
    public class DBInitialzier
    {
        public static void EnsurePopulated(IServiceProvider services)
        {
            ...
            //If table Errands is empty, populate it
            ...
            //If table Departments is empty, populate it
            ...
            //If table ErrandStatuses is empty, populate it
            ...
            //If table Employees is empty, populate it
            ...
            //If table Sequences is empty, populate it
