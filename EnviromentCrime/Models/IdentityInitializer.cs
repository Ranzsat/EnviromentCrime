...
namespace EnviromentCrime.Models
{
    ...
    {
        /**
         * Method that populates the server by using the other methods of
         * this class.
         * The method is only used when the server need to be populated
         * with a migration
         */
        ...
        //Method for creating the different roles
        ...
        //Method for createing the initial users
        private static async Task CreateUsers(UserManager<IdentityUser> uManager)
        {
            ...
            //Passwords
            //TODO add function to update passwords and ask users to change thier passowrds
